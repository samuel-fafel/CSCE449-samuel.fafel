...
proc create_root_design { parentCell } {
  ...
  # Create port connections
  connect_bd_net -net GND_dout [get_bd_pins clk_wiz_1/reset] [get_bd_pins ground/dout]
  ...
  connect_bd_net -net xlconstant_0_dout [get_bd_pins rst_clk_wiz_1_100M/ext_reset_in] [get_bd_pins vdd/dout]

  # Create address segments
  create_bd_addr_seg -range 0x00010000 -offset 0x40000000 [get_bd_addr_spaces microblaze_0/Data] [get_bd_addr_segs led/S_AXI/Reg] SEG_axi_gpio_0_Reg
