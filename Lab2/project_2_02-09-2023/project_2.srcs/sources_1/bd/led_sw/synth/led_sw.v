...
(* CORE_GENERATION_INFO = "led_sw,IP_Integrator,{x_ipVendor=xilinx.com,x_ipLibrary=BlockDiagram,x_ipName=led_sw,x_ipVersion=1.00.a,x_ipLanguage=VERILOG,numBlks=18,numReposBlks=13,numNonXlnxBlks=0,numHierBlks=5,maxHierDepth=1,numSysgenBlks=0,numHlsBlks=0,numHdlrefBlks=0,numPkgbdBlks=0,bdsource=USER,da_axi4_cnt=1,da_board_cnt=4,da_mb_cnt=1,synth_mode=Global}" *) (* HW_HANDOFF = "led_sw.hwdef" *) 
module led_sw
   (clock_rtl,
    led_tri_o);
  (* X_INTERFACE_INFO = "xilinx.com:signal:clock:1.0 CLK.CLOCK_RTL CLK" *) (* X_INTERFACE_PARAMETER = "XIL_INTERFACENAME CLK.CLOCK_RTL, CLK_DOMAIN led_sw_clock_rtl, FREQ_HZ 100000000, INSERT_VIP 0, PHASE 0.000" *) input clock_rtl;
...
module microblaze_0_local_memory_imp_6JY8HV
  ...
  (* BMM_INFO_ADDRESS_SPACE = "byte  0x00000000 32 > led_sw microblaze_0_local_memory/lmb_bram" *) 
  (* KEEP_HIERARCHY = "yes" *) 
